...
void Gates::deutschAlgorithm_2(int f_of_zero, int f_of_one)
{
    cout << endl;
    //when f(x) is constant
    if(f_of_zero == f_of_one)
    {
        if(f_of_zero == 0)
        {
            cout << "1|0> [(|0>-|1>)/√(2)]";
    ...
    else if (f_of_zero != f_of_one)
    {
        if(f_of_zero == 0 && f_of_one == 1)
        {
            cout << "1|1> [(|0>-|1>)/√(2)]";
        }
        else if (f_of_zero == 1 && f_of_one == 0)
        {
            cout << "-1|1> [(|0>-|1>)/√(2)]";
        }
    }
